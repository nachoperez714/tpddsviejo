...
public class AgregarCondicionTipo2Window extends SimpleWindow<ConfigurarCondicionViewModel> {
	
	private ElegirCondicionWindow ventanaElegir;
	
	public AgregarCondicionTipo2Window(WindowOwner parent, String condicion) {
	...
	public void createContents(Panel panelActions)  {
		...
		new Label(panelActions).setText("Ingrese un anio");
	...
	public boolean usuarioSePasaDeListo() {
		return getModelObject().getAnio().isEmpty() || getModelObject().getIndicadorSeleccionado() == null|| getModelObject().getOperacionIndicadorSeleccionada() == null;
	}
